...
export default function App() {
  const [currentLessonId, setCurrentLessonId] = useState('basic-concepts');
  const [view, setView] = useState('lesson'); // 'lesson' | 'quiz' | 'result' | 'intro'
        ...
        <div className="content-wrapper">
          {view === 'intro' && (
            <div className="animate-fade-in text-center p-8">
              <h1 className="gradient-text" style={{ fontSize: '3.5rem' }}>Master SAT Percentages</h1>
              <p style={{ fontSize: '1.25rem', marginBottom: '3rem' }}>The complete course for a perfect score in Math.</p>
              
              <div className="flex flex-stack-mobile gap-6" style={{ marginBottom: '4rem' }}>
